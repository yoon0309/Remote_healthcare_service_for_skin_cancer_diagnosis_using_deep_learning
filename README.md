...
- 피부암 별 특성으로는 기저세포암, 편평세포암과 흑색종으로 나뉘는데
- 기저세포암, 편평세포암은 혈류나 림프절을 통한 전이확률과 사망률은 낮지만 재발 시 보기에 흉측해질 수 있습니다.
- 흑색종은 혈류나 림프절을 통해 신체의 다른 부위로 퍼지며, 방치 시 사망에 이를 수 있으며 일반 점(모반)과 형태가 비슷해 조기에 구분하지 못하는 경우가 많습니다. 그렇기에 흑색종을 잘 구별하는 것이 필요합니다. 
...
-> 이들 지역의 지방의료 감소로 고령인구가 많은 지방이 상대적으로 의료 혜택을 보기 어려운 상황에 처해있음을 확인 할 수 있었습니다. 
